...
SELECT FIRST_NAME , SALARY, SALARY+300 AS dollar300 FROM EMPLOYEES;
...
SELECT FIRST_NAME,JOB_ID FROM EMPLOYEES WHERE JOB_ID='IT_PROG' OR JOB_ID = 'SA_MAN'; -- JOB_ID IN ('IT_PROG','SA_MAN');
--13. Steven King 사원의 정보를 “Steven King 사원의 급여는 24000달러 입니다” 형식으로 출력하세요.
SELECT FIRST_NAME||' '||LAST_NAME || ' 사원의 급여는 '||SALARY||'달러 입니다' AS DETAIL FROM EMPLOYEES WHERE FIRST_NAME ='Steven' and LAST_NAME ='King';
